...
@section('content')
    ...
    <div class="container print-none">
        <ul class="nav nav-tabs mt-2">
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('category.index') }}">All Records</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('category.create') }}">New Entry</a>
            </li>
        </ul>
    </div>
    <!-- container menu end -->
    ...
    <div class="container">
        ...
        <div class="card border-0">
            <div class="card-header p-0 d-md-flex align-items-center border-0 d-block">
                ...
                <!-- refresh -->
                <a href="{{ route('category.index') }}" class="btn top-icon-button print-none ms-auto" title="Refresh">
                ...
                <!-- add -->
                <a href="{{ route('category.trash') }}" class="btn top-icon-button print-none" title="Trash">
                        ...
                        <tbody>
                            @forelse($categories as $category)
                                ...
                                <td class="print-none text-end">
                                    ...
                                    <a href="{{ route('category.edit', $category->id) }}" class="btn btn-sm table-small-button"
