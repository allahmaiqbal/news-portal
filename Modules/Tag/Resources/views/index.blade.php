...
@section('content')
    ...
    <div class="container print-none">
        <ul class="nav nav-tabs mt-2">
            <li class="nav-item">
                <a class="nav-link active" href="element_records.html">All Records</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="element_entry.html">New Entry</a>
            </li>
        </ul>
    </div>
    <!-- container menu end -->
    ...
    <div class="container">
        ...
        <div class="card border-0">
            <div class="card-header p-0 d-md-flex align-items-center border-0 d-block">
                ...
                <!-- refresh -->
                <a href="{{ route('tag.index') }}" class="btn top-icon-button print-none" title="Refresh">
