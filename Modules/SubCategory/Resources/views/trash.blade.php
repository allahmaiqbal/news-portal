...
<div class="container print-none">
    <ul class="nav nav-tabs mt-2">
        ...
        <li class="nav-item">
            <a class="nav-link active" >SubCategory Trash</a>
        </li>
    </ul>
</div>
<!-- container menu end -->
    ...
    <div class="card border-0">
        ...
        <div class="card-body p-0">
            ...
            <div class="table-responsive">
                <form action="{{ route('subcategory.trash') }}" method="POST">
                    @csrf
                        ...
                        <tbody>
                            ...
                            <th scope="row" class="p-0">
                                <label class="p-2 d-block">
                                    <input type="checkbox" name="subCategory[]" value="{{ $subcategory->id }}" class="me-2">
                                    {{ $loop->iteration }}.
                                </label>
                            </th>
                            ...
                            <td class="print-none text-end">
                                <a href="{{ route('subcategory.restore', $subcategory->id) }}" class="btn table-small-button"
                                    title="Update">
                                    <i class="bi bi-bootstrap-reboot"></i></a>
                                <form action="{{ route('subcategory.permanentDelete', $subcategory->id) }}" class="d-inline"
                    ...
                    <div class="mt-3 text-end">
                        <button class="btn btn-sm btn-success me-2" name="restore" value="1"
                            ...
                            $subCategories->count() > 0 ? '' : 'disabled' }}>Restore all</button>
                        ...
                        <button class="btn btn-sm  btn-danger" name="delete" value="1"
                            ...
                            $subCategories->count() > 0 ? '' : 'disabled' }}>Permanently delete</button>
                    </div>
                </form>
