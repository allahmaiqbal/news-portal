    ...
    <div class="card-body p-0 pt-3">
        <form action="{{ route('sub-category.update',$subCategory->id) }}" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-6">
                    <select class="form-select custom" id="select" name="category_id">
                        ...
                        <option class="text-left" value="{{ $item->id }}" {{ $subCategory->category_id == $item->id ? 'selected':'' }}>
                            {{ $item->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="row mb-3">
                ...
                <div class="col-6">
                    <x-forms.input type="text" value="{{ $subCategory->name }}" name="name" required placeholder="Enter Name" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-8">
                    <x-forms.input type="textarea" value="{{ $subCategory->description }}" name="description" placeholder="enter description" />
                </div>
            </div>
