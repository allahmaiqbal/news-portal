...
@section('content')
    ...
    <div class="container print-none">
        <ul class="nav nav-tabs mt-2">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('video.create') }}" >New Entry</a>
            </li>
        </ul>
    </div>
    <!-- container menu end -->
    ...
    <div class="container">
        ...
        <div class="card border-0">
            <div class="card-header p-0 d-md-flex align-items-center border-0 d-block">
                <!-- page title -->
                <div class="mt-3 mb-2">
                    <h4 class="main-title">List of videos</h4>
                    <p><small>About {{ count($videos) }} results.</small></p>
                </div>
            </div>
                        ...
                        <tbody>
                            @forelse($videos as $video)
                                <tr>
                                    ...
                                    <td>{{  Illuminate\Support\Str::limit($video->link, 30, ' ......')  }}</td>

                                    <td class="print-none text-end">
                                        {{-- <a href="element_details.html" class="btn table-small-button" title="View"><i
                                                class="bi bi-eye"></i></a> --}}
                                        <a href="{{ route('video.edit', $video->id) }}" class="btn table-small-button"
