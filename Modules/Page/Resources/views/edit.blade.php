    ...
    <div class="container">
        <div class="card mb-5 border-0">
            <div class="card-header p-0 border-0 d-flex">
                <!-- page title -->
                <div class="mt-3">
                    <h4 class="main-title">Edit new page</h4>
                </div>
        ...
        <div class="card-body p-0 pt-3">
            <form action="{{ route('pages.update', $page->id) }}" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        <x-forms.input type="text" value="{{ $page->name }}" name="name" required
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-8">
                        <x-forms.input type="textarea" name="description" value="{{ $page->description }}"
